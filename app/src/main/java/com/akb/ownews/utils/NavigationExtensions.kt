...
import androidx.navigation.ui.R as utsR
...
private fun commitTransaction(
    ...
    fragmentManager.beginTransaction()
        .setCustomAnimations(
            utsR.anim.nav_default_enter_anim,
            utsR.anim.nav_default_exit_anim,
            utsR.anim.nav_default_pop_enter_anim,
            utsR.anim.nav_default_pop_exit_anim
        )
...
fun NavController.navigateOrNull(direction: NavDirections?, clearTask: Boolean = false) {
    try {
        val options = NavOptions.Builder().apply {
            setEnterAnim(utsR.anim.nav_default_enter_anim)
            setExitAnim(utsR.anim.nav_default_exit_anim)
            setPopEnterAnim(utsR.anim.nav_default_pop_enter_anim)
            setPopExitAnim(utsR.anim.nav_default_pop_exit_anim)
